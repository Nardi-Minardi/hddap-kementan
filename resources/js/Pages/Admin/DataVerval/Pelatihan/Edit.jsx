...
export default function PelatihanEdit({ pelatihan }) {
    const { data, setData, patch, processing, errors } = useForm({
        komponen: pelatihan.komponen || '',
        nama_kegiatan: pelatihan.nama_kegiatan || '',
        kode_owp: pelatihan.kode_owp || '',
    });
    ...
    return (
        <AdminLayout title="Edit Management Topik">
            <Head title="Edit Management Topik" />
            ...
            <Card
                ...
                title={<Title level={5} className="!mb-0 !text-gray-800">Edit Management Topik</Title>}
            >
