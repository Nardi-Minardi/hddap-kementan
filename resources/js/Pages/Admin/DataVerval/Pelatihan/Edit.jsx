...
export default function PelatihanEdit({ pelatihan, jenisPelatihanOptions = [] }) {
    const { data, setData, patch, processing, errors } = useForm({
        kdjenis: pelatihan.kdjenis ?? null,
        tanggal: toDateInputValue(pelatihan.tanggal),
        lokasi: pelatihan.lokasi || '',
        jumlah_jpl: pelatihan.jumlah_jpl ?? null,
        laki_laki: pelatihan.laki_laki ?? null,
        perempuan: pelatihan.perempuan ?? null,
    });

    const handleSubmit = () => {
        patch(route('admin.data-verval.pelatihan.update', pelatihan.kd_pelatihan));
    };

    return (
        <AdminLayout title="Edit Pelatihan">
            ...
            <Card
                ...
                title={<Title level={5} className="!mb-0 !text-gray-800">Edit Data Pelatihan</Title>}
            >
