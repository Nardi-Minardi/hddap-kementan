...
import {
    Table, Card, Input, Select, Typography, Tag, Space, Modal, Button, Popconfirm, Tooltip, message,
} from 'antd';
...
export default function KelompokPetaniTab({ poktan, provinsis, kabKotas, filters }) {
    ...
    const anggotaColumns = [
        { title: 'No', key: 'no', width: 55, render: (_, __, i) => i + 1 },
        { title: 'Nama Petani', dataIndex: 'nama_petani', key: 'nama_petani', render: (v) => v ?? '-' },
        { title: 'NIK', dataIndex: 'nik_petani', key: 'nik_petani', render: (v) => v ?? '-' },
        { title: 'No HP', dataIndex: 'no_hp_petani', key: 'no_hp_petani', render: (v) => v ?? '-' },
        {
            title: 'Gender',
        ...
        { title: 'Alamat', dataIndex: 'alamat_petani', key: 'alamat_petani', render: (v) => v ?? '-' },
    ];
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 py-1">
                        ...
                        <Space wrap>
                            ...
                            <Select
                                ...
                                onChange={(val) => goToList({ provinsi_code: val ?? '', kode_kota: '', page: 1 })}
